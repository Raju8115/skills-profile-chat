...
class DB2Client:
    def __init__(self):
        ...
        Environment variables:
            ...
            DB2_PORT
            DB2_DATABASE
            DB2_SCHEMA (optional, for prefixing table names)
        """
        ...
        self.schema = os.getenv("DB2_SCHEMA", "")  # Optional schema prefix
        self.conn = None
        ...
        print(f"DB2 Client initialized for database: {self.database}")
        if self.schema:
    ...
    def connect(self):
        ...
        try:
            connection_string = (
                ...
                f"UID={self.username};"
                f"PWD={self.password};"
                f"SECURITY=SSL;"  # SSL ON, no cert verification
            )
...
#     # os.environ["DB2_USERNAME"] = "mlr04294"
#     # os.environ["DB2_PASSWORD"] = "cTPN902iVXArJlVR"
#     # os.environ["DB2_HOSTNAME"] = "your-hostname"
#     # os.environ["DB2_PORT"] = "30756"
#     # os.environ["DB2_DATABASE"] = "BLUDB"

#     # query = "SELECT * FROM MLR04294.PRODUCTS FETCH FIRST 10 ROWS ONLY"
#     query = "SELECT product_id, name, price FROM MLR04294.Products"
